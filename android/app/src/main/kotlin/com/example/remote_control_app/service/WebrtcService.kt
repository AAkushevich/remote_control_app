/*
package com.example.remote_control_app.service

import com.example.remote_control_app.repository.AppRepository
...
import com.example.remote_control_app.socket.SocketClient
import com.example.remote_control_app.webrtc.WebrtcClient
...
@AndroidEntryPoint
class WebrtcService @Inject constructor() : Service() , AppRepository.Listener {

    companion object {
        var screenPermissionIntent: Intent ?= null
        var surfaceView: SurfaceViewRenderer ?= null
        var listener: AppRepository.Listener ?= null
    }

    @Inject lateinit var mainRepository: AppRepository
    ...
    override fun onCreate() {
        super.onCreate()
        var gson = Gson()
        mainRepository = AppRepository(SocketClient(gson), WebrtcClient(this, gson), gson)
